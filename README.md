...
Dash component to add custom button to scroll to the top of the page.
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> dash-scroll-up -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import dash-scroll-up to your layout, then run it:
